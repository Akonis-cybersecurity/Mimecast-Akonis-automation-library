...
SAMPLE_STATS = [{"date": "2026-04-01", "malicious": 5, "clean": 100}]


@pytest.fixture
def action(module):
    a = MimecastGetStatsAttachmentScans(module=module)
    a.log = MagicMock()
    return a
...
class TestGetStatsAttachmentScansSuccess:
    ...
    def test_correct_endpoint(self, action):
        ...
        assert action.client.get_v2.call_args[0][0] == "/threats/v1/stats/attachment-scans"
...
class TestGetStatsAttachmentScansErrors:
